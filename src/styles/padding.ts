export const paddingStyle = (() => {
    ...
    type Keys = keyof typeof paddingAmounts;
    type Values = typeof paddingAmounts[Keys];
    type Options = 'all' | 'top' | 'right' | 'bottom' | 'left' | 'horizontal' | 'vertical';

    return Object.fromEntries(
        Object.entries(paddingAmounts)
            .map(
                ([v, k]) => {
                    const style = paddingAmounts[v as Keys];
                    ...
                    return [
                        v,
                        {
                            ...
                            horizontal: { paddingLeft: style, paddingRight: style },
                            vertical: { paddingTop: style, paddingBottom: style },
                        }
                    ];
                }
